package cn.kli.lottery.framework.utils;

import android.content.Context;
import android.content.SharedPreferences;
import cn.kli.lottery.App;
...
public class PrefUtils {
    ...
    public static void putInt(final String key,
            final int value) {
    ...
    public static void putFloat(final String key,
            final float value) {
    ...
    public static void putLong(final String key,
            final long value) {
